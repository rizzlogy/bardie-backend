class Bard {
  ...
  async #init(cookie) {
    ...
    try {
      ...
      throw new Error(
        "Could not use your Cookie. Make sure that you copied the Cookie with the name __Secure-1PSID correctly. If you are sure your cookie is correct, you may also have reached your rate limit.",
      );
    }
  }
  ...
  async #uploadImage(name, buffer) {
    ...
    try {
      ...
      throw new Error(
        "Could not upload the image to Google Bard. Make sure you are connected to the internet: " +
          e,
      );
    }
  }
