...
async questionGeminiWithImage(message, data) {
    ...
    try {
        ...
        // Jika data adalah URL, ambil gambar dari URL
        if (typeof data === 'string') {
            ...
            if (!validImageTypes.includes(contentType)) {
                return {
                    content: "Please input a valid image URL (png, jpg, jpeg, webp, gif)!",
                    status: false,
                    creator: "RizzyFuzz",
                };
            }
            ...
            const contentType = mime.lookup(data);
            const validImageTypes = [
                "image/png",
                "image/jpg",
                "image/jpeg",
            ...
            if (!validImageTypes.includes(contentType)) {
                return {
                    content: "Please input a valid image buffer (png, jpg, jpeg, webp, gif)!",
                    status: false,
                    creator: "RizzyFuzz",
                };
            }
            ...
            return {
                content: "Invalid input data! Please provide a valid URL or image buffer.",
                status: false,
                creator: "RizzyFuzz",
            };
        }
