...
class BardAI {
  constructor() {
    ...
    this.bardie = "https://bard.google.com/_/BardChatUi/data/assistant.lamda.BardFrontendService/StreamGenerate";
  }
  ...
  async question(input_text) {
    try {
      ...
      const response = await this.session.post(this.bardie, qs.stringify(this.data), {
        params: this.params,
        headers: {
